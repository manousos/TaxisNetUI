...
public class E1Bean {
    ...
    public void setAircraftMonthOwnerShip(Integer aircraftMonthOwnerShip) {
	this.aircraftMonthOwnerShip = aircraftMonthOwnerShip;
    }
    ...
    public Boolean getAgrHasWater1() {
	return agrHasWater1;
    }

    public void setAgrHasWater1(Boolean agrHasWater1) {
	this.agrHasWater1 = agrHasWater1;
    }

    public Float getAgrNetIncome1() {
	return agrNetIncome1;
    }
    ...
    public Boolean getAgrHasWater2() {
	return agrHasWater2;
    }

    public void setAgrHasWater2(Boolean agrHasWater2) {
	this.agrHasWater2 = agrHasWater2;
    }

    public Float getAgrNetIncome2() {
	return agrNetIncome2;
    }
    ...
    public Boolean getAgrHasWater3() {
	return agrHasWater3;
    }

    public void setAgrHasWater3(Boolean agrHasWater3) {
	this.agrHasWater3 = agrHasWater3;
    }

    public Float getAgrNetIncome3() {
	return agrNetIncome3;
    }
    ...
    public Boolean getAgrHasWater4() {
	return agrHasWater4;
    }

    public void setAgrHasWater4(Boolean agrHasWater4) {
	this.agrHasWater4 = agrHasWater4;
    }

    public Float getAgrNetIncome4() {
	return agrNetIncome4;
    }
	...
	E1taxableIncomes taxableIncomeObj = new E1taxableIncomes(_301, _302,
		...
		agrPopulation2, agrLocationType2, BooleanToInt(agrHasWater2),
		agrNetIncome2, agrTotalNetincome2, agrTotalWifeNetincome2,
		agrLocation3, agrProdKind3, agrPopulation3, agrLocationType3,
